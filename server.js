...
app.get('/kls1', (req, res) => res.sendFile(path.join(__dirname, 'static', 'de', 'index.htm')));
app.get('/kls2', (req, res) => res.sendFile(path.join(__dirname, 'static', 'kls/de', 'index.htm')));
